...
public class Mycontactform_rentalinfoform {
	...
	WebElement ele2,ele3,ele4,ele5,ele6,ele7,ele8,ele9,ele10,ele11,ele12,ele13,ele14,ele15;
	...
	driver.findElement(By.name("q[2]")).sendKeys("Tamil");
	...
	ele14=driver.findElement(By.xpath("//*[@id=\"center_col\"]/h4"));
